...
export default function FoodItem({ meal }) {
  ...
  return (
    <li className="max-h-140">
      <article
        className={`flex flex-col justify-self-center w-full max-w-77 h-full rounded-2xl text-center transition-all duration-200 shadow-lg ${itemIsAdded && "drop-shadow-[0_0_3px_#05df72,0_0_7px_#05df72]"} ${itemIsAdded ? "hover:drop-shadow-[0_0_3px_#05df72,0_0_7px_#05df72]" : "hover:drop-shadow-[0_0_3px_#FFBF00,0_0_7px_#FFBF00]"}`}
      >
        <img
